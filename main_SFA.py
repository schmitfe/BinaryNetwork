from ClusteredEI_network_SFA import *
import numpy as np
...
if __name__ == "__main__":
    ...
    network = ProbClusteredEI_Network(Q, N_E, N_I, p, g, pep, Rj, threshold_E, threshold_I, tau_theta_E, theta_q_E, tau_theta_I, theta_q_I)
